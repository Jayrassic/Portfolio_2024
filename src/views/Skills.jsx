...
const Skills = () => {
  ...
  const isInView = useInView(divRef, { margin: "-1px" });
  ...
  return (
    <motion.div
      ...
      viewport={{ amount: 0.1 }}
      ref={divRef}
      className="no-scrollbar flex w-full snap-start  flex-col overflow-x-hidden overflow-y-scroll p-4 sm:max-h-screen sm:min-h-screen sm:p-8"
    >
      ...
      <motion.div
        className=" flex w-full flex-grow flex-col gap-4 p-4 text-lg sm:m-auto sm:justify-around "
